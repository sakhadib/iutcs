...
<body>
    ...
    {{-- @else --}}
        <!-- Header -->
        <header class="text-center mb-8 sm:mb-12 pt-4 sm:pt-8">
            <div class="inline-block mb-3 sm:mb-4 px-3 sm:px-4 py-1 bg-purple-900/30 text-purple-300 rounded-full text-sm font-medium border border-purple-700/50">
        ...
        <div class="card p-4 sm:p-6 lg:p-8 mb-8 sm:mb-12 border-2 border-green-500/50 glow text-center">
            ...
            <div class="space-y-4">
                ...
                <p class="text-sm sm:text-base text-gray-400">
                    Make sure your repository contains all required files and documentation
                </p>
            </div>
        </div>
        @endif
